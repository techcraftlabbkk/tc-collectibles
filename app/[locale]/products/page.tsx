...
export default function Products() {
  ...
  return (
    <div className="w-full bg-white">
      {/* Page Header */}
      <section className="w-full px-4 py-12 bg-gradient-to-r from-emerald-600 to-teal-600 text-white">
      ...
      <section className="w-full px-4 py-12">
        <div className="max-w-6xl mx-auto">
          {/* Filters & Sort Bar */}
          <div className="flex flex-col sm:flex-row gap-4 mb-8 pb-6 border-b-2 border-emerald-200">
            <select
              value={sortBy}
              onChange={(e) => setSortBy(e.target.value)}
              className="flex-1 px-4 py-3 border-2 border-emerald-300 rounded-lg focus:outline-none focus:border-amber-400 font-semibold"
            >
              ...
              {products.map((product) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    {/* CTA */}
                    <button className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white py-2 rounded-lg font-bold text-sm transition-all transform hover:scale-105 active:scale-95">
                      View Details →
                    </button>
                  </div>
                </Link>
