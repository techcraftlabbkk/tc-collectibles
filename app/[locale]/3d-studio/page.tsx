                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <textarea value={prompt} onChange={e => setPrompt(e.target.value)}
                      ...
                      className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm resize-none h-24 focus:outline-none focus:ring-2 focus:ring-purple-400" />
                  </div>
                  <div>
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 space-y-3">
                      ...
                      {aiJob.status !== 'succeeded' && aiJob.status !== 'failed' && (
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div className="bg-purple-600 h-2 rounded-full transition-all" style={{ width: `${aiJob.progress}%` }} />
                        </div>
                      )}
                      {aiJob.thumbnailUrl && (
