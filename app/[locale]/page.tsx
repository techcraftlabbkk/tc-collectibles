...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full bg-gradient-to-r from-emerald-600 via-teal-600 to-blue-600 text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 py-24 sm:py-32 lg:py-40">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href={`/${locale}/products`}
                className="inline-block border-2 border-white text-white hover:bg-white hover:text-emerald-600 px-8 py-4 rounded-lg font-bold text-lg transition-all duration-200"
              >
                Browse Gallery
              </Link>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {products.map((product) => (
                ...
                >
                  ...
                  {/* Card Info */}
                  <div className="p-4">
                    <h3 className="font-bold text-gray-900 text-sm mb-2 line-clamp-2 group-hover:text-emerald-600 transition-colors">
                      {product.title}
                    </h3>
                    ...
                    {/* CTA */}
                    <button className="w-full mt-4 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white py-2 rounded-lg font-bold text-sm transition-all transform hover:scale-105 active:scale-95">
                      View Details
                    </button>
                  </div>
                </Link>
      ...
      <section className="w-full px-4 py-16 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Authentic */}
            <div className="text-center p-8 rounded-2xl border-2 border-emerald-200 hover:border-amber-400 hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-emerald-50 to-transparent">
            ...
            {/* Verified */}
            <div className="text-center p-8 rounded-2xl border-2 border-emerald-200 hover:border-amber-400 hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-teal-50 to-transparent">
            ...
            {/* Secure */}
            <div className="text-center p-8 rounded-2xl border-2 border-emerald-200 hover:border-amber-400 hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-blue-50 to-transparent">
              <div className="text-6xl mb-4">🔒</div>
